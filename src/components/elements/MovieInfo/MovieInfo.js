        ...
        >
            <div className="content">
                ...
                <div className="text">
                    ...
                    <h3>IMDB RATING</h3>
                    <div className="ybm-rating">
                        <meter min="0" max="100" optimum="100" low="40" high="70" value={props.movie.vote_average * 10}></meter>
                        <p className="ybm-score">{props.movie.vote_average}</p>
                    </div>
                    {props.directors.lenght > 1 ? <h3>DIRECTORS</h3> : <h3>DIRECTOR</h3>}
                    {props.directors.map( (element, i) => {
                        return <p key={i} className="ybm-director">{element.name}</p>
                    })}
                </div>
